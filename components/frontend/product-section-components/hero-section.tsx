...
export default function HeroSection() {
  ...
  return (
    <>
        <section className='px-4 md:px-0 md:max-w-7xl container mx-auto flex-col-reverse md:flex md:flex-row md:items-center gap-4'>
            <div className="md:border-b md:border-r md:border-l md:rounded-b-lg md:px-4 md:pb-4 w-full flex-col items-center justify-center space-y-2 md:w-1/2">
