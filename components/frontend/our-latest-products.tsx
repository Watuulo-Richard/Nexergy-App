    ...
    <>
      <section className="bg-[#121820] md:container py-4 md:py-16 md:max-w-7xl md:mx-auto">
        <div className="flex justify-center pb-4">
          <h3 className="text-xl md:text-3xl font-semibold text-red-600">
        ...
        <div className="mx-4 md:mx-4 grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
