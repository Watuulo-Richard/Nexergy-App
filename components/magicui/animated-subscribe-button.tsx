      ...
      <AnimatePresence mode="wait">
        {isSubscribed ? (
          ...
          <motion.button
            ref={ref}
            className={cn(
              "relative flex h-10 w-fit cursor-pointer items-center justify-center rounded-lg bg-transparent px-6 text-primary-foreground border border-slate-600",
              className,
            )}
            onClick={(e) => {
          ...
          >
            <motion.span
              key="reaction"
              className="relative flex items-center justify-center font-semibold text-xs"
              initial={{ x: 0 }}
