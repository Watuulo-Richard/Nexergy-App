...
>(({ children, className, ...props }, ref) => {
  return (
    ...
    >
      <span
        className="relative block size-full text-xs uppercase tracking-wide border border-red-600 text-red-600 p-2 rounded-md dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
