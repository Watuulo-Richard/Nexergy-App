...
>(({ children, className, ...props }, ref) => {
  return (
    ...
    >
      <span
        className="relative block size-full text-xs uppercase tracking-wide border border-slate-600 text-slate-400 p-2 rounded-md dark:font-light dark:text-[rgb(255,255,255,90%)]"
        style={{
          maskImage:
