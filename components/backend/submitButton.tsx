...
import { Loader, LoaderPinwheel, LogIn, Plus } from "lucide-react";
    ...
    <>
      {loading ? (
        ...
        <button
          type="submit"
          className={cn(
            "flex items-center justify-center rounded-md bg-red-600 px-3 py-2 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600",
            className
          )}
        >
